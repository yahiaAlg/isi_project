    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "color",
                    models.CharField(
                        default="#6B7280", max_length=7, verbose_name="Couleur (hex)"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invoice_type",
                    models.CharField(
                        choices=[("formation", "Formation"), ("etude", "Étude")],
                        db_index=True,
                        max_length=20,
                        verbose_name="Type",
                    ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True, max_length=255, verbose_name="Nom client (snapshot)"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True, max_length=20, verbose_name="Type client (snapshot)"
                    ),
                ),
                (
                    "client_nif_snapshot",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="NIF client (snapshot)"
                    ),
                ),
                (
                    "client_nis_snapshot",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="NIS client (snapshot)"
                    ),
                ),
                (
                    "client_rc_snapshot",
                    models.CharField(
                        blank=True, max_length=100, verbose_name="RC client (snapshot)"
                    ),
                ),
                (
                    "client_ai_snapshot",
                    models.CharField(
                        blank=True,
                        max_length=100,
                        verbose_name="ART.I client (snapshot)",
                    ),
                ),
                (
                    "client_nin_snapshot",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="NIN client (snapshot)"
                    ),
                ),
                (
                    "client_rib_snapshot",
                    models.CharField(
                        blank=True, max_length=255, verbose_name="RIB client (snapshot)"
                    ),
                ),
                (
                    "invoice_date",
                ...
                (
                    "due_date",
                    models.DateField(
                        blank=True, null=True, verbose_name="Date d'échéance (finale)"
                    ),
                ),
                (
                    "finalized_at",
                ...
                (
                    "bon_commande_date",
                    models.DateField(blank=True, null=True, verbose_name="Date du BC"),
                ),
                (
                    "bon_commande_amount",
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount_ht",
                    models.DecimalField(
                        decimal_places=2, max_digits=14, verbose_name="Montant HT (DA)"
                    ),
                ),
                (
                    "tva_rate",
                ...
                (
                    "amount_tva",
                    models.DecimalField(
                        decimal_places=2, max_digits=14, verbose_name="Montant TVA (DA)"
                    ),
                ),
                (
                    "amount_ttc",
                    models.DecimalField(
                        decimal_places=2, max_digits=14, verbose_name="Montant TTC (DA)"
                    ),
                ),
                (
                    "is_full_reversal",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(
                        decimal_places=2, max_digits=14, verbose_name="Montant (DA)"
                    ),
                ),
                (
                    "method",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        max_length=255,
                        verbose_name="Fournisseur / bénéficiaire",
                    ),
                ),
                (
                    "payment_reference",
                ...
                (
                    "approval_notes",
                    models.TextField(blank=True, verbose_name="Notes d'approbation"),
                ),
                ("notes", models.TextField(blank=True, verbose_name="Notes")),
                (
            ...
            options={
                ...
                "ordering": ["-date"],
                "indexes": [
                    models.Index(fields=["date"], name="financial_e_date_e5ec32_idx"),
                    models.Index(
                        fields=["approval_status"],
                        name="financial_e_approva_a9a0dd_idx",
                    ),
                    models.Index(
        ...
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["phase", "status"], name="financial_i_phase_f3ff89_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["client", "phase", "status"],
                name="financial_i_client__1cb790_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["invoice_type", "invoice_date"],
                name="financial_i_invoice_1d4eeb_idx",
            ),
        ),
    ]
