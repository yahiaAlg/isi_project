...
class TrainerForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'daily_rate', 'phone', 'email', 'notes', 'is_active'
        ]
        widgets = {
...
class EquipmentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'current_value', 'condition', 'status', 'location',
...
class EquipmentUsageForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['equipment', 'assigned_to_session', 'assigned_to_project', 'date', 'duration_hours', 'context']
        widgets = {
    ...
    def clean(self):
        ...
        if assigned_to_session and assigned_to_project:
            raise ValidationError("Veuillez sélectionner soit une session, soit un projet, pas les deux.")
...
class MaintenanceLogForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['equipment', 'date', 'maintenance_type', 'cost', 'performed_by', 'description', 'next_due_date']
        widgets = {
            'equipment': forms.Select(attrs={'class': 'form-select'}),
            'date': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
